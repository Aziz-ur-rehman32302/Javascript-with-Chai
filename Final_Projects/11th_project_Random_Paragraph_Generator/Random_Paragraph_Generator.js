...
//===============           GeneratePara Function Start         ===========================
 
const GeneratePara=()=>{
    // console.log(userInput.value);
     if (isNaN(userInput.value) || userInput.value < 0 || userInput.value > 9) {
        ...
        //  console.log(text[randomIndex]);
         ...
         text_box.innerHTML = `
         <p>${text[randomIndex]}</p>
         `
    }else{
        const localText = shuffle(text);
        // console.log(localText);
        
        const data = localText.slice(0, userInput.value)
        // console.log(data);
        // console.log(data.toString());
        const para = data.map(element => {//map as leya use kiya ha q k ha return data ha jo k foreach loop nei dati
          console.log(element);
        ...
        // joinarray ke saare elements ko ek single string mein convert karta hai — aur beech mein aap apni marzi ka separator daal sakte ho.
